...
<html>
				...
				<input type="hidden" name="id" value="${var.dispatch_id}">
							<tr>
								<td  style="width: 30px;">${vs.index+1}</td>
										...
										<c:when test="${var.status=='2'}">校核未通过</c:when>
  ...
  <table width="100%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td width="60%" align="right">
												[
												<a href="check/list?page=1"
													class="right-font08">首页</a> |
												<a
													href="check/list?page=${page.pagebefore}"
													class="right-font08">上一页</a> |
												<a
													href="check/list?page=${page.pageafter}"
  ...
  <script>
  	...
  	function edit(Id){
  		location.href="<%=basePath%>check/goedit?DISPATCH_ID="+Id;
  	}
  </script>
</html>
