...
<html>
  ...
  <table width="100%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td width="60%" align="right">
												[
												<a href="receipt/list?page=1"
													class="right-font08">首页</a> |
												<a
													href="receipt/list?page=${page.pagebefore}"
													class="right-font08">上一页</a> |
												<a
													href="receipt/list?page=${page.pageafter}"
  ...
  <script>
  	...
  	function edit(Id){
  		location.href="<%=basePath%>receipt/goedit?DISPATCH_ID="+Id;
  	}
  </script>
</html>
