...
<html>
				...
				<c:forEach items="${varlist}" var="var" varStatus="vs">
							<tr>
								<td  style="width: 30px;">${vs.index+1}</td>
										...
										<td><input type="button" value="查看/修改"  onclick="edit('${var.mail_receive_id}' );"></td>
							</tr>
				</c:forEach>
				</tbody>
	</table>
  ...
  <table width="100%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td width="60%" align="right">
												[
												<a href="mail/receivelist?page=1"
													class="right-font08">首页</a> |
												<a
													href="mail/receivelist?page=${page.pagebefore}"
													class="right-font08">上一页</a> |
												<a
													href="mail/receivelist?page=${page.pageafter}"
  ...
  <script>
  	...
  	function edit(Id){
  		location.href="<%=basePath%>mail/check?MAIL_RECEIVE_ID="+Id;
  	}
  </script>
</html>
