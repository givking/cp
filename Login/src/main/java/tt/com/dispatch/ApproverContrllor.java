...
public class ApproverContrllor {
	...
	public ModelAndView goedit(HttpServletRequest req) throws Exception{
		...
		mv.setViewName("dispatch/approver/approver_edit");
		return mv;
	}
	@RequestMapping("/edit")
	...
	public ModelAndView list(PageUtil page,HttpServletRequest req) throws Exception{
		...
		List<Dispatch> varlist = dispatchService.approverlist(page);
		mv.addObject("varlist",varlist);
		mv.addObject("page", page);
		mv.setViewName("dispatch/approver/approver_list");
		return mv;
